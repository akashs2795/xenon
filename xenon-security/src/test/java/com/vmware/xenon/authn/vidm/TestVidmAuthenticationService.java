...
//            this.host.waitForServiceAvailable(VidmAuthenticationService.SELF_LINK);
...
//        URI authServiceUri = UriUtils.buildUri(this.host, VidmAuthenticationService.SELF_LINK);
...
////                        .toString().getBytes()));
////        String headerVal = new StringBuffer("Vidm ").append(userPassStr).toString();
////        this.host.testStart(1);
...
//        String userPassStr = new String(Base64.getEncoder().encode(
//                new StringBuffer(USER).append(VIDM_AUTH_USER_SEPERATOR).append(PASSWORD)
//                        .toString().getBytes()));
//        String headerVal = new StringBuffer(VIDM_AUTH_PREFIX).append(userPassStr).toString();
//        this.host.testStart(1);
//        this.host.send(Operation
//                .createPost(authServiceUri)
//                .setBody(new Object())
